...
A compact map of the knowledge base. Use this when the question is broad and you need to jump quickly to the right page.
...
|---|---|---|---|
| tcgen05 MMA instruction | `hw-tcgen05-mma` | `wiki/hardware/tcgen05-mma.md` | Blackwell tensor-core instruction; CTA-scope (`cta_group::1`) or cluster-scope (`cta_group::2`). |
...
|---|---|---|
| Warp specialization | `technique-warp-specialization` | Complex kernels that benefit from separate MMA, epilogue, and load roles. |
...
| DSL | Page ID | Notes |
|---|---|---|
| CuTe DSL | `lang-cute-dsl` | High-level path for modern NVIDIA tensor-core kernels; especially strong on SM100. |
