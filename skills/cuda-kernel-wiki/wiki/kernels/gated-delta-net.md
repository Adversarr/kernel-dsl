...
Archived benchmark material for this page uses the following representative setup:
- Parameters: `qk_dim=4`, `v_dim=8`, `d=128`
- Benchmarks: decode `qk4_v8_d128_k_last`, prefill `qk4_v8_d128_k_last`
- Implementation status in the archived corpus: decode done for both Hopper and Blackwell; prefill done on Hopper, in progress for Blackwell
...
- Archived FlashInfer benchmark materials
