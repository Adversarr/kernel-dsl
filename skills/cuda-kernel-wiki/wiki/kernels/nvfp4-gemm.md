...
Archived benchmark material for this kernel came from the GPU Mode NVFP4 corpus. The durable lesson is that once NVFP4 GEMM becomes compute-bound, performance depends on tcgen05 scheduling, TMA feed efficiency, TMEM accumulator handling, and warp-specialized execution.
...
Archived benchmark runs place optimized NVFP4 GEMM at roughly 10.8 us geometric-mean latency across the tracked problem set, landing close to cuBLAS-class FP4 throughput on B200.
