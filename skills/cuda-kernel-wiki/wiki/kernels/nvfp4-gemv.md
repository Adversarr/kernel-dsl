...
Archived NVFP4 benchmark material gives a useful roofline reference here: the theoretical speed-of-light is about 8.6 us for the largest tracked config on B200, while optimized kernels land around 22.4 us because FP4 decoding, scale handling, and memory movement dominate the total cost.
...
Documented progression from a public optimization write-up built on the archived benchmark corpus:
...
| Final tuned kernel | All combined | 22.392us |
...
- Archived GPU Mode NVFP4 benchmark materials
- [Yue's NVFP4 optimization write-up](https://yue-zhang-2025.github.io/2025/12/02/blackwell-nvfp4-kernel-hackathon-journey.html)
